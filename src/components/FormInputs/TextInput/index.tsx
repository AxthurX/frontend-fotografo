	...
	return (
		<>
			...
			<input
				...
				id={fieldId}
				className={cn(
					'input input-bordered h-10 w-full rounded-none px-2 focus:outline focus:outline-[3px] focus:outline-offset-0 focus:outline-blue-300 disabled:border-solid disabled:border-gray-400 disabled:border-opacity-40 disabled:text-gray-600 read-only:border-solid read-only:border-gray-400 read-only:border-opacity-40 read-only:text-gray-600',
					classNameInput,
				)}
